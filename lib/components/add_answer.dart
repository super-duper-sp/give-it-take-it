            ...
            children: <Widget>[
              DecoratedBox(
                decoration: BoxDecoration(
                  color:Color(0xffDFD8FB), //background color of dropdown button
                ...
                child: Padding(
                  ...
                  child: DropdownButton<String>(
                    hint: Center(child: Padding(
                      ...
                      child: Text('Select a question',style: TextStyle(color: Color(0xff242424))),
                    )),
                ...
                child: Text('Submit Answer'),
                  style: ElevatedButton.styleFrom(
                    primary: Color(0xff242424),
                      padding: EdgeInsets.all(20), // Increase padding to increase size
